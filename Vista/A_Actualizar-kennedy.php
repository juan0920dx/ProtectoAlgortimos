...
<body>
    <div class="contenedor">
        ...
        <h2>Sede Kennedy</h2>
        <br>
        <form id="formulario-actualizar-producto" enctype="multipart/form-data" action="../Controlador/A_actualizarProductoK.php" method="POST">
            ...
            <a href="A_Inventario-kennedy.php" class="boton">Cancelar</a>
        </form>
    </div>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (idProducto) {
                fetch(`../Controlador/A_ObtenerProductoK.php?id=${idProducto}`)
                    .then(response => response.json())
                    .then(data => {
                        document.getElementById('id-producto').value = data.idProductoK;
                        document.getElementById('nombre-producto').value = data.productoK;
                        document.getElementById('precio-producto').value = data.PrecioK;
                        document.getElementById('descripcion-producto').value = data.descripcionK;
                        document.getElementById('cantidad-producto').value = data.cantidadK;
                    })
        ...
        document.getElementById('formulario-actualizar-producto').addEventListener('submit', function(event) {
            ...
            .then(data => {
                alert(data); 
                window.location.href = "A_Inventario-kennedy.php"; 
            })
