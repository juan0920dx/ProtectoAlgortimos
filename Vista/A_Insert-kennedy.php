...
<body>
    <div class="contenedor">
        ...
        <h2>Sede Kennedy</h2>
        <br>
        <form id="formulario-producto" enctype="multipart/form-data" action="../Controlador/A_insertarProductoK.php" method="POST">
        <div class="grupo-formulario">
            ...
            <a href="A_Inventario-kennedy.php" class="boton">Volver</a>
        </form>
    </div>
</body>
</html>
