...
<body>
    <div class="contenedor">
        ...
        <h2>Sede Suba</h2>
        <br>
        <form id="formulario-producto" enctype="multipart/form-data" action="../Controlador/A_insertarProductoS.php" method="POST">
        <div class="grupo-formulario">
            ...
            <a href="A_Inventario-suba.php" class="boton">Volver</a>
        </form>
    </div>
</body>
</html>
